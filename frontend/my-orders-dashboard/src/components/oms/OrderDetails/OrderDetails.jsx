...
import { fetchOrderDetailsThunk } from '../../../redux/oms/orderDetailsSlice';
...
function OrderDetails() {
  ...
  return (
    <div className="container">
      ...
      <table>
        <thead>
          <tr><th>Image</th><th>OrderItemId</th><th>SKU</th><th>Qty</th><th>UnitPrice</th><th>Discount</th><th>FinalPrice</th><th>Size</th><th>Status</th><th>SellerId</th></tr>
        </thead>
        <tbody>
          {orderItems.map((item, i) => (
            <tr key={i}>
              <td>
                <img
                  src={`/assets/oms/${item.productId}.jpg`}
                  alt="Product"
                  width="60"
                  height="80"
